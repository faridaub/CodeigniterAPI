...
class Search_customer_setting_api extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->FNCTIN = Api_const::A024;	//お客様設定情報検索API
	}
	public function index()
	{
		...
		try {
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.searchCustomerSettingInformation";
			...
			if (!$this->xmlrpc->send_request()) {
				...
				if ($b_result['errrCode'] == Api_const::BCMN0000){
					$jsonOut = array(
	 					'newsPushFlag' => $b_result['newsPushFlag'],
	 					'myFvrtsPushFlag' => $b_result['myFvrtsPushFlag'],
	 					'nrstHtlsPushFlag' => $b_result['nrstHtlsPushFlag'],
	 					'dstnc' => $b_result['dstnc']
					);
				}
