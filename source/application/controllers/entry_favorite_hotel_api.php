...
class Entry_favorite_hotel_api extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->FNCTIN = Api_const::A021;	//お気に入りホテル登録API
	}
	...
	public function index()
	{
		...
		try {
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.entryMyFavorites";
			...
			$request = array(
					...
					array($rqst['fvrtHtlCode'], 'string'),
					array($rqst['dltFlag'], 'string')
					);
			// Call BService
