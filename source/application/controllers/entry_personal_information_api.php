...
class Entry_personal_information_api extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->FNCTIN = Api_const::A029;	//個人情報登録API
	}
	public function index()
	{
		...
		try {
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.addCustomerInformation";
			...
			$request = array(
					...
					array($rqst['pcEmlAddrss'], 'string'),
					array($rqst['nwslttr'], 'string'),
					array($rqst['mblEmlAddrss'], 'string'),
