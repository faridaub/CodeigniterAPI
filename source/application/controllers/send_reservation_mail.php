...
class send_reservation_mail_api extends CI_Controller {
	...
	public function index()
	{
		...
		try {
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.sendReservationMail";
