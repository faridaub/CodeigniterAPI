...
class Send_password_forgotten_mail_api extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->FNCTIN = Api_const::A035;	//パスワード忘れメール送信API
	}
	...
	public function index()
	{
		...
		try {
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.sendPasswordForgottenEmail";
			...
			if (!$this->xmlrpc->send_request()) {
				...
				if ($error_code==Api_const::BCMN0000) {
					$jsonOut = array(
						'athntctnKey' => $b_result['athnctnKey'],
