...
class Attests_name_birth_date_api extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->FNCTIN = Api_const::A027;	//姓名・生年月日認証API
	}
	public function index()
	{
		...
		try {
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.loginDateBirthAndName";
