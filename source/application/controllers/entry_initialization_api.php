...
class Entry_initialization_api extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->FNCTIN = Api_const::A034;	//初期設定情報登録API
	}
	...
	public function index()
	{
		...
		try {
			...
			//PRCSSNG_TYPE_MEMBER	= "1"	//1:会員の方
			//PRCSSNG_TYPE_GENERAL	= "2"	//2:一般の方
			if ( $rqst['prcssngType'] == Api_const::PRCSSNG_TYPE_MEMBER || $rqst['prcssngType'] == Api_const::PRCSSNG_TYPE_GENERAL){
				$ids += array('rsrvsPrsnUid', $rqst['rsrvsPrsnUid']);				
			}
			// API共通チェック
			...
			$method = "com.toyokoinn.api.service.SmartphoneApplicationCustomerService.registrationInitialization";
