	...
	public function index() {
		...
		try {
			...
			$ids = array(
					'rsrvsPrsnUid',
					'pageNmbr',
					//20141204 パラメーター fvrtHtlCode 追加 iwamoto
					'fvrtHtlCode'
			);
			// API共通チェック
...
exit;
			...
			//20141204 fvrtHtlCodeに値が設定されて
			//fvrtHtlCodeとBサービスの戻り値のホテルコードが一致した場合はnmbrMyFvrtsに1を設定
			//一致しない場合はnmbrMyFvrtsに0を設定　　iwamoto
			if ( $rqst['fvrtHtlCode']!='' )[
			}
