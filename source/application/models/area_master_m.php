...
class area_master_m extends CI_Model
{

    var $CLASS_NAME = 'area_master_m';                   // Class name
    var $TABLE_NAME = 'area_master';                     // Table name
     ...
     *
     */
    function select($lngg, $cntry_code, $area_code)
    {
        //-------
        // 初期値
        //-------
