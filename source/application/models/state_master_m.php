...
class state_master_m extends CI_Model
{

    var $CLASS_NAME = 'state_master_m';                   // Class name
    var $TABLE_NAME = 'state_master';                     // Table name
    ...
    /*
     * 都道府県マスタテーブルのレコードリストを取得する
     *
     * @param   array   $params : パラメータ
     * @return  array   $result :  戻り値
     *              ['err_code']: エラーコード(true=正常終了/ false=異常終了)
     *              ['mssg']    : エラーメッセージ
     *              ['list']    : 検索で取得した都道府県マスタテーブルのリスト
     *
     */
