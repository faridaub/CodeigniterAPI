...
class web_discount_information_m extends CI_Model
{

    var $CLASS_NAME = 'web_discount_information_m';                   // Class name
    var $TABLE_NAME = 'web_discount_information';                     // Table name
    ...
    function update($rec){
        ...
        //-------------------------
        // web_discount_informationの更新処理
        //-------------------------
        if($result['errCode'] == true){
            $rec['vrsn_nmbr'] = $rec['vrsn_nmbr']+1;   // バージョン番号をカウントUP

            // web_discount_informationテーブルにupdateする。
    ...
    /*
     * WEB割引情報テーブルのレコードリストを取得する
     *
     * @param   array   $params : パラメータ
     * @return  array   $result :  戻り値
     *              ['err_code']: エラーコード(true=正常終了/ false=異常終了)
     *              ['mssg']    : エラーメッセージ
     *              ['list']    : 検索で取得したWEB割引情報テーブルのリスト
     *
     */
