...
class hotel_image_m extends CI_Model
{

    var $CLASS_NAME = 'hotel_image_m';                   // Class name
    var $TABLE_NAME = 'hotel_image';                     // Table name
    ...
    /*
     * ホテルイメージ情報テーブルのレコードリストを取得する
     *
     * @param   var    $htl_infrmtn_unq_id : ホテルユニークコード
 	 * @param   var    $lngg : 言語
     * @return  array   $result :  戻り値
     *              ['err_code']: エラーコード(true=正常終了/ false=異常終了)
     *              ['mssg']    : エラーメッセージ
     ...
     *
     */
    function selectListCond($htl_infrmtn_unq_id, $lngg)
    {
        //-------
        // 初期値
        //-------
